      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Locations /{" "}
            <span className="text-gray-700">Nursingsarathi Indore</span>
          </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div>
                ...
                <h1 className="text-3xl font-bold text-gray-900 mb-2">
                  Nursingsarathi Indore
                </h1>

                <p className="font-semibold text-gray-700 mb-3">
                  Clean city, smart care
                </p>

                <p className="text-gray-600 text-sm leading-relaxed mb-3">
                  From Vijay Nagar to Rau, we bring tech-enabled
                  nursing with wellness partnerships.
                </p>

                <p className="text-gray-600 text-sm">
                  Loved by startup founders, athletes, and young
                  families.
                </p>
              </div>
              ...
              <div className="bg-gray-100 rounded-2xl p-4">
                <div className="relative h-64 w-full rounded-xl overflow-hidden">
                  <Image
                    ...
                    alt="Nursingsarathi Indore setup"
                    fill
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <FeatureCard
                number="1"
                title="Sports recovery pods"
                desc="Cryotherapy, kinesio taping, and sports physio at home."
              />
              <FeatureCard
                number="2"
                title="Diabetes reversal clubs"
                desc="Nutritionists + health coaches deliver cohort-based programs."
              />
              <FeatureCard
                number="3"
                title="Smart home alerts"
                desc="IoT buttons for SOS, medication reminders, and vitals sync."
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            <div className="border rounded-xl p-6">
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                {[
                  "Corporate tie-ups in Crystal IT Park",
                  "University health desks for IIM / IPS",
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-6">
              <h3 className="font-semibold mb-2">
                Launching a campus clinic?
              </h3>
              <p className="text-sm text-gray-600 mb-4">
                We set up nurse stations and health dashboards
                in 2 weeks.
              </p>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  ...
                  Indore without repeated hospital visits.
                </li>
                <li>
          ...
          <div className="bg-gray-100 rounded-2xl p-8">
            ...
            <h2 className="text-xl font-bold mb-4">
              Frequently asked about Nursingsarathi Indore
            </h2>
