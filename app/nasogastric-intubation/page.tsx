      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-4 py-10">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Services /{" "}
            <span className="text-gray-700">Nasogastric Intubation</span>
          </p>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              <div>
                ...
                <p className="font-semibold text-gray-700 mb-3">
                  Safe enteral access within minutes
                </p>

                <p className="text-gray-600 text-sm leading-relaxed">
                  We place nasogastric (NG) and nasojejunal (NJ) tubes with
                  pH confirmation, X-ray coordination, and complete feeding
                  protocol setup.
                </p>

                <p className="text-gray-600 text-sm mt-3">
                  Perfect for dysphagia, neurological deficits, oncology cases,
                  or short-term nutrition support after surgery.
                </p>
              </div>
              ...
              <div className="bg-gray-100 rounded-2xl p-4">
                <div className="relative h-64 w-full rounded-xl overflow-hidden">
                  <Image
                    ...
                    alt="Nasogastric Intubation setup"
                    fill
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
              ...
              <StatCard title="TUBE LIBRARY" value="10 sizes" />
              <StatCard title="FEED PROGRAM SETUP" value="<2 hrs" />
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <FeatureCard
                  number="1"
                  title="Comfort-centric insertion"
                  desc="Topical anaesthesia, posture coaching, and guided swallowing cues."
                />
                <FeatureCard
                  number="2"
                  title="Feeding plan handover"
                  desc="Bolus vs continuous schedules, pump priming, and flush routines documented."
                />
                <FeatureCard
                  number="3"
                  title="Monitoring & troubleshooting"
                  desc="Aspiration checks, displacement alerts, and clog management education."
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
              <div className="border rounded-xl p-6">
                ...
                <ul className="space-y-3 text-sm text-gray-600">
                  <li className="flex gap-2">
                    ...
                    Airway safety screening
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle className="w-4 h-4 text-blue-600 mt-0.5" />
                    pH confirmation + optional radiology
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle className="w-4 h-4 text-blue-600 mt-0.5" />
                    Documentation for doctors and payors
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-6">
                <h3 className="font-semibold mb-2">
                  Have paediatric needs?
                </h3>
                <p className="text-sm text-gray-600 mb-4">
                  Dedicated paediatric nurses carry smaller bore tubes and
                  playful distraction kits.
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 text-sm text-gray-600">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>Families wanting structured NG care without hospital visits</li>
                  <li>Patients needing predictable schedules and escalation pathways</li>
                  <li>Doctors extending in-hospital protocols into home care</li>
                </ul>
              </div>
            ...
            <div className="mt-14">
              ...
              <h2 className="text-xl font-bold mb-4">
                Frequently asked about nasogastric intubation
              </h2>
