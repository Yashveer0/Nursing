...
export default function GastrosciencesPage() {
  return (
      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-4 py-10">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Speciality / <span className="text-gray-700">Gastrosciences</span>
          </p>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              <div>
                ...
                <p className="font-semibold text-gray-700 mb-3">
                  Digestive relief with diet + diagnostics
                </p>

                <p className="text-gray-600 text-sm leading-relaxed">
                  IBD, liver disease, bariatric recovery, or pancreatitis — we
                  layer gastroenterologist plans with microbiome-focused nutrition.
                </p>

                <p className="text-gray-600 text-sm mt-3">
                  Includes home phlebotomy, stool sample pickups, and proactive
                  hydration tracking.
                </p>
              </div>
              ...
              <div className="bg-gray-100 rounded-2xl p-4">
                <div className="relative h-64 w-full rounded-xl overflow-hidden">
                  <Image
                    src="/gastrosciences.jpg"
                    alt="Gastrosciences program"
                    fill
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
              <StatCard title="FLARE-UP REDUCTION" value="42%" />
              <StatCard title="HOME LAB TURNAROUND" value="6 hrs" />
              <StatCard title="DIET PLANS DELIVERED" value="800+/yr" />
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <FeatureCard
                  number="1"
                  title="Trigger journal app"
                  desc="Log meals, moods, and symptoms to spot hidden patterns."
                />
                <FeatureCard
                  number="2"
                  title="Gut-friendly meal prep"
                  desc="Chef partners craft bile-friendly, low-residue menus."
                />
                <FeatureCard
                  number="3"
                  title="Micronutrient review"
                  desc="Quarterly vitamin & mineral audits with supplementation support."
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
              <div className="border rounded-xl p-6">
                ...
                <ul className="space-y-3 text-sm text-gray-600">
                  <li className="flex gap-2">
                    ...
                    GI doctor on-loop updates
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle className="w-4 h-4 text-blue-600 mt-0.5" />
                    Hydration + electrolyte tracker
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle className="w-4 h-4 text-blue-600 mt-0.5" />
                    Mind-gut therapy group invites
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-6">
                <h3 className="font-semibold mb-2">
                  Need ER coordination?
                </h3>
                <p className="text-sm text-gray-600 mb-4">
                  We prep your file and alert partner hospitals in advance.
                </p>
            ...
            <div className="mt-14">
              ...
              <h2 className="text-xl font-bold mb-4">
                Frequently asked about gastrosciences programs
              </h2>
