      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Locations /{" "}
            <span className="text-gray-700">Nursingsarathi Patna</span>
          </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div>
                ...
                <h1 className="text-3xl font-bold text-gray-900 mb-2">
                  Nursingsarathi Patna
                </h1>

                <p className="font-semibold text-gray-700 mb-3">
                  Eastern India’s dependable nurse grid
                </p>

                <p className="text-gray-600 text-sm leading-relaxed mb-3">
                  Kankarbagh operations handle Patna, Hajipur,
                  Bihta Airport Road, and satellite towns.
                </p>

                <p className="text-gray-600 text-sm">
                  Empanelled with major insurers and state health
                  schemes.
                </p>
              </div>
              ...
              <div className="bg-gray-100 rounded-2xl p-4">
                <div className="relative h-64 w-full rounded-xl overflow-hidden">
                  <Image
                    ...
                    alt="Nursingsarathi Patna setup"
                    fill
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <FeatureCard
                number="1"
                title="Trauma-ready teams"
                desc="Coordination with AIIMS Patna and Paras HMRI for quick transfers."
              />
              <FeatureCard
                number="2"
                title="Public health drives"
                desc="Village immunisation support and chronic disease screening."
              />
              <FeatureCard
                number="3"
                title="Telemedicine bridge"
                desc="Connects rural patients with metro specialists instantly."
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            <div className="border rounded-xl p-6">
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                {[
                  "Government empanelment IDs verified",
                  "Equipment rentals delivered same-day",
                  "Special fares for long-term care",
                ].map((item) => (
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Build pop-up clinics with our community health
                workers.
              </p>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  ...
                  Patna without repeated hospital visits.
                </li>
                <li>
          ...
          <div className="bg-gray-100 rounded-2xl p-8">
            ...
            <h2 className="text-xl font-bold mb-4">
              Frequently asked about Nursingsarathi Patna
            </h2>
