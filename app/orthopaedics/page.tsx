        ...
        <div className="max-w-6xl mx-auto px-4 py-10">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Joint replacements, sports injuries, and spine corrections
                  recover faster with our strength coaches and robotic rehab tools.
                </p>

                <p className="text-gray-600 text-sm mt-3">
                  Pain specialists, physiotherapists, and occupational therapists
                  deliver goal-based routines.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
              <StatCard title="RETURN-TO-MOBILITY" value="2× faster" />
              <StatCard title="HOME PHYSIO SESSIONS" value="15k+/yr" />
              <StatCard title="PAIN REDUCTION" value="65%" />
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <FeatureCard
                  number="1"
                  title="3D gait analysis"
                  desc="Camera-based tracking to personalise drills and posture."
                />
                <FeatureCard
                  number="2"
                  title="Strength + stretch pods"
                  desc="Modular equipment designed to fit into apartments."
                />
                <FeatureCard
                  number="3"
                  title="Pain school"
                  desc="Workshops on ergonomics, cold/heat therapy, and pacing."
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
              <div className="border rounded-xl p-6">
                ...
                <ul className="space-y-3 text-sm text-gray-600">
                  <li className="flex gap-2">
                    ...
                    Post-op wound surveillance
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle className="w-4 h-4 text-blue-600 mt-0.5" />
                    Thrombosis prevention plan
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle className="w-4 h-4 text-blue-600 mt-0.5" />
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Rent CPM machines, braces, and smart ice sleeves from us.
                </p>
            ...
            <div className="mt-14">
              ...
              <h2 className="text-xl font-bold mb-4">
                Frequently asked about orthopaedics programs
              </h2>
