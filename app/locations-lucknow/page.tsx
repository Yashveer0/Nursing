      ...
      {city.name}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-3">
                  Our Hazratganj hub serves Lucknow, Kanpur Road,
                  Indira Nagar, and the Gomti Nagar extension.
                </p>

                <p className="text-gray-600 text-sm">
                  Special focus on chronic care and rehabilitation
                  for joint families.
                </p>
              </div>
              ...
              <div className="bg-gray-100 rounded-2xl p-4">
                <div className="relative h-64 w-full rounded-xl overflow-hidden">
                  <Image
                    ...
                    alt="Nursingsarathi Lucknow setup"
                    fill
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <FeatureCard
                number="1"
                title="Home ICU setups"
                desc="Ventilators, monitors, and infusion pumps installed within hours."
              />
              <FeatureCard
                number="2"
                title="Maternal care"
                desc="Lactation experts and newborn nurses on rotating schedules."
              />
              <FeatureCard
                number="3"
                title="Ayush + modern blend"
                desc="Yoga therapists and counsellors collaborate with allopathic teams."
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            <div className="border rounded-xl p-6">
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                {[
                  "Tie-ups with SGPGI & Medanta Avadh",
                  "Doorstep lab sample pickups",
                  "Translators for overseas families",
                  "Festive surge planning",
                ].map((item) => (
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-6">
              <h3 className="font-semibold mb-2">
                Pre-book nurses for special occasions
              </h3>
              <p className="text-sm text-gray-600 mb-4">
                Weddings, chhathi, or long vacations.
              </p>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  ...
                  Lucknow without repeated hospital visits.
                </li>
                <li>
                  Patients needing predictable nursing schedules
                  and clear escalation pathways.
                </li>
                <li>
                  Doctors looking for a reliable at-home extension
                  of in-hospital protocols.
                </li>
              </ul>
            </div>
          ...
          <div className="bg-gray-100 rounded-2xl p-8">
            ...
            <h2 className="text-xl font-bold mb-4">
              Frequently asked about Nursingsarathi Lucknow
            </h2>
